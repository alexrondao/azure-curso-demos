            ...
            if (!context.Clientes.Any())
            {
                ...
                if(!context.Produtos.Any())
                {
                    context.Produtos.AddRange(
                        new Produto[]
                        {
                            new Produto(){Nome="Camisa de Polo", Preco = 110.99M, Tipo = vestuario},
                            new Produto(){Nome="Camisa de Regata", Preco = 130, Tipo = vestuario},
                            new Produto(){Nome="Caderno 10M", Preco = 30.45M, Tipo = papelaria},
                            new Produto(){Nome="Sabonete", Preco = 3.99M, Tipo = higiene},
                        }
                        );
                }
